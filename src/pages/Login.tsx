		...
		<div className="min-h-screen flex items-center justify-center">
			<div className="bg-gray-800 p-8 rounded-lg shadow-lg">
				...
				<div className="mb-4 border border-white/10 rounded-lg flex items-center gap-3">
					<CircleUserRound className="size-6 m-2 text-emerald-300" />
				...
				<div className="mb-4 border border-white/10 rounded-lg flex items-center gap-3">
					<AtSign className="size-6 mx-2 text-emerald-300" />
				...
				<div className="flex flex-col gap-2 justify-between">
					<button className="px-4 py-2 rounded hover:bg-emerald-500 bg-emerald-600 text-zinc-300 font-bold text-sm">REALIZAR INSCRIÇÃO</button>
